...
//        return $data;
        return view('mobile.resume.resumeList',['data' => $data]);
    }
    // 返回添加简历页面的基本信息
    // 同时设置intention 表
...
//        return $data;
        return view('mobile.resume.resumeInfo', ["data" => $data]);
    }
    //ranxl add
    public function getIntention(Request $request){ //求职意向
        $input = $request->all();
        $data = array();
        $data['uid'] = AuthController::getUid();
        $data['username'] = InfoController::getUsername();
        ...
        $data['resume'] = Resumes::find($data['rid']);
        $data['intention'] = Intention::find($data['resume']['inid']);
        $data['region'] = Region::all(); //地区
        $data['occupation'] = Occupation::orderBy('updated_at','asc')->get();//职业
        $data['industry'] = Industry::all();//行业
        return view('mobile.resume.jobIntension', ["data" => $data]);
    }
    public function getEduExpInfo(){//教育经历
        ...
        $data['education'] = $this->getEducation();
//        return $data;
        return view('mobile.resume.commonList', ["data" => $data]);
    }
    public function getWorkExpInfo(){//工作经历
        $data = array();
        $data['uid'] = AuthController::getUid();
        $data['username'] = InfoController::getUsername();
        $data['type'] = AuthController::getType();
...
//        return $data;
    ...
    public function getProExpInfo(){//项目经历
        $data = array();
        $data['uid'] = AuthController::getUid();
        $data['username'] = InfoController::getUsername();
        $data['type'] = AuthController::getType();
...
//        return $data;
    ...
    public function getGameExpInfo(){//电竞经历
        $data = array();
        $data['uid'] = AuthController::getUid();
        $data['username'] = InfoController::getUsername();
        $data['type'] = AuthController::getType();
        ...
        $data['game'] = $this->getEgamexpr();
        $data['egame'] = Egame::all();//游戏
        $data['egrade'] = Egrade::all();//等级
//        return $data;
        return view('mobile.resume.commonList', ["data" => $data]);
    }
    public function getSkillInfo(Request $request){//技能
        $input = $request->all();
        $data = array();
        $data['uid'] = AuthController::getUid();
        $data['username'] = InfoController::getUsername();
...
//        return $data;
    ...
    */
    public function getResumeList() {
        $uid = AuthController::getUid();
        $result['resumes'] = Resumes::where('uid', '=', $uid)
            ->select('rid', 'inid', 'resume_name')
            ->get();
        foreach ($result['resumes'] as $resume){
            $result['completion'][$resume->rid] = $this->Completion_total($resume->rid);
        }
        return $result;
    }
...
//        return $data;
        return view('mobile/resume/previewResume', ["data" => $data]);
    }
...
//        $data['position'] = Position::where('vaildity', '>=', date('Y-m-d H-i-s'))
    ...
    public function geteduinfo(Request $request){
        if(!$request){
            return view("mobile.resume.eduExperienceInfo");
        }
        $data =array();
        $data['uid'] = AuthController::getUid();
        $data['username'] = InfoController::getUsername();
...
//        return $data;
        return view("mobile.resume.eduExperienceInfo",['data' => $data]);
    }
    //获取待修改工作经历数据信息
...
//        return $data;
        return view("mobile.resume.workExperienceInfo",['data' => $data]);
    }
    //获取待修改项目经历数据信息
...
//        return $data;
        return view("mobile.resume.projectExperienceInfo",['data' => $data]);
    }
    //获取待修改电竞经历数据信息
    public function getegameinfo(Request $request){
        ...
        $data['egrade'] = Egrade::all();//等级
//        return $data;
        return view("mobile.resume.gamingExperienceInfo",['data' => $data]);
    }
    ...
    public function addskillinfo(Request $request){
        ...
        $data['rid'] = $input['rid'];
//        return $data;
        return view("mobile.resume.skill",['data' => $data]);
    }
