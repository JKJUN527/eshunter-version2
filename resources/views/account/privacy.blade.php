...
@section('content')
   <div id="container_wrap clearfix" class="container">
          <div class="content_wrap ua">
            <dl>
              <dt>
                <h2> 
                  <em></em>
              ...
              <dd>
                        ...
                        <h6>（六）免责条款</h6>
                        1、使用者理解并同意eshunter.com对以下情况免责：
                                              （1）应聘信息发布方对存入简历中心的个人简历及材料的格式、内容的真实性、准确性和合法性负有全部责任，招聘信息发布方对于其在职位数据库公布的材料的真实性、准确性和合法性负有全部责任。eshunter.com仅是提供职位发布等信息的平台，eshunter.com不对应聘及招聘信息的真实性、有效性、准确性负责。
