                                ...
                                @if($newsItem->picture != null)
                                    ...
                                    <li>
                                        <a href="news/detail?nid={{$newsItem->nid}}" target="_blank">
                                            ...
                                            {{--<b>{{mb_strcut($newsItem->title,0,52,'utf-8')}}</b>--}}
                                            <b>{{$newsItem->title}}</b>
        ...
        <div class="ad_company gongsi_list">
                        ...
                        <div class="item_top">
                            <p>
                                <a href="/company?eid={{$ad_big->eid}}" target="_blank">
                                    <img src="{{$ad_big->picture or asset('images/house.jpg')}}" alt="" width="200"
                                         height="100" style="margin-left: 12.5px;"/>
                                </a>
                            </p>
            ...
            <ul class="ad_company_list clearfix nav-logos tuijian-company">
                @foreach($data['ad']['ad1'] as $ad1)
                    <li class="nav-logo" data-tj-exposure="off" data-lg-tj-type="xiaoyuan_ad" data-lg-tj-id="19ng"
                        data-lg-tj-no="idnull" data-lg-tj-cid="7" data-reactid="319">
                        <div class="nav-img" data-reactid="320" to="/company?eid={{$ad1->eid}}">
                            <img src="{{$ad1->picture or asset('images/house.jpg')}}" width="90" height="90"
                                 data-reactid="321">
