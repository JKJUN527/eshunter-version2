                                ...
                                <li>
                                    <div class="d_item clearfix">
                                        ...
                                        <div class="d_resume">
                                            ...
                                            <a class="btn_showprogress delviery_success_btn"
                                               onclick="show_progress({{$apply->pid}});">
                                                    <span>
                                                        @if($apply->status == 0)
                                                            投递成功
                                    ...
                                    <div class="progress_status progress_status_one{{$apply->pid}} dn"
                                         style="display: none;">
                                        <ul class="status_steps">
                                            <li class="@if($apply->status >= 0) status_done @else status_grey @endif status_1">
                                                1
                                            </li>
                                            <li class="status_line @if($apply->status >=1) status_line_done @else status_line_grey @endif">
                                                <span></span></li>
                                            <li class="@if($apply->status >=1) status_done @else status_grey @endif">
                                                <span>2</span></li>
                                            <li class="status_line @if($apply->status >=2) status_line_done @else status_line_grey @endif">
                                                <span></span></li>
                                            <li class="@if($apply->status >=2) status_done @else status_grey @endif">
                                                <span>3</span></li>
                                        </ul>
                                        ...
                                        <ul class="status_list">
                                            <li class="top1">
                                                ...
                                                <div class="list_body">
                                                    <img src="{{$data['applylist']['ename'][$apply->eid]->elogo}}"
                                                         style="border-radius:50%;" width="60" heigth="60">
                                        ...
                                        <a class="btn_closeprogress up_btn"
                                           onclick="hide_progress({{$apply->pid}})"></a>
                                    </div>
                                </li>
                            @endforeach
                        </ul>
                                    ...
                                    <li>
                                        <div class="d_item clearfix">
                                            <div class="d_job">
                                                <a href="/position/detail?pid={{$apply->pid}}" class="d_job_link"
                                                   target="_blank">
                                                    <em class="d_job_name">{{mb_substr($apply->title,0,20,'utf-8')}}
                                                        ...</em>
                                                    <span class="d_job_salary">
                                                        @if($apply->salary == -1)
                                                            工资面议
